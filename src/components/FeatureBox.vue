<template>
	<figure
		class="flex flex-col-reverse items-center justify-center lg:justify-between"
	...
	>
		...
		<figcaption>
			<img
				:src="img"
				class="mt-8 mb-8 h-64 rounded shadow-xl lg:mt-0"
				:class="shadow"
			/>
		</figcaption>
	</figure>
...
export default {
	name: "FeatureBox",
	props: ["shadow", "bg", "text", "title", "right", "img", "btn"],
};
</script>
